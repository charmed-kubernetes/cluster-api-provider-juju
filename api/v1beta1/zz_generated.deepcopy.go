...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in Attrs) DeepCopyInto(out *Attrs) {
	{
		in := &in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Attrs.
func (in Attrs) DeepCopy() Attrs {
	if in == nil {
		return nil
	}
	out := new(Attrs)
