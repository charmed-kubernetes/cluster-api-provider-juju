...
func (in *JujuClusterSpec) DeepCopyInto(out *JujuClusterSpec) {
	*out = *in
	...
	if in.AdditionalApplications != nil {
		in, out := &in.AdditionalApplications, &out.AdditionalApplications
		*out = make([]Charm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AdditionalIntegrations != nil {
		in, out := &in.AdditionalIntegrations, &out.AdditionalIntegrations
		*out = make([]Endpoints, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
